...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="./scripts/CRUW2022", max_truncation = 0, min_height = 25, max_occlusion = 2, \
        ...
        self.t_sha             = t_sha
        self.t_path            = os.path.join("./results/CRUW2022", t_sha, "data_%d" % (int(num_hypo)-1))
...
class stat:
    ...
    def plot(self):
        save_dir = os.path.join("./results/CRUW2022", self.t_sha)
